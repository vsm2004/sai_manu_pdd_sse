...
public class FinalizeBookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Booking finalized successfully! 🎉", Toast.LENGTH_LONG).show();
        ...
        new android.os.Handler(android.os.Looper.getMainLooper()).postDelayed(() -> {
            Intent tourTypesIntent = new Intent(FinalizeBookingActivity.this, TourTypesCatalogue.class);
